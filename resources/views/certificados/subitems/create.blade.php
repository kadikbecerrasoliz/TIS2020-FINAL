<div class="modal-header text-center">
    <h5 class="modal-title w-100" id="exampleModalLabel">Subir Subitem</h5>
    ...
    <form action="{{ route('certificados.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <select class="browser-default custom-select" id="subitem_id" name="subitem_id">
                    <option value="{{$subitem->id}}"> {{$subitem->titulo}} </option>
                </select>
            </div>
        </div>
        <div class="form-row">
