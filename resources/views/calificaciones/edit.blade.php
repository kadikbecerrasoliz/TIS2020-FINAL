<div class="modal-header text-center">
    <h5 class="modal-title w-100" id="exampleModalLabel">Editar Calificacion</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form action="{{ route('calificaciones.update', [$postulation->id, $postulationRequerimiento->id]) }}" method="POST" class="text-center">
        {{ csrf_field() }}
        {{ @method_field('PUT') }}
