...
<div class="modal-body">
    <form action="{{ route('meritos.update', $merito->id) }}" method="POST" class="text-center">
        ...
        <div class="form-row">
            <div class="col">
                <div class="md-form">
                    <input type="number" min="0" id="materialRegisterFormpuntos" class="form-control" aria-describedby="materialRegisterFormpuntosHelpBlock" name="puntos" value="{{ $merito->puntos }}" required>
